...
export default class Input {
  ...
  constructor(element, opts) {
    ...
    this._mousewheelHandleFirefox = event => {
      event.preventDefault();
      event.stopPropagation();
  ...
  _registerMousewheelEvent() {
    ...
    this._element.addEventListener('DOMMouseScroll', this._mousewheelHandleFirefox, { passive: false });
  }

  _unregisterMousewheelEvent() {
    this._element.removeEventListener('mousewheel', this._mousewheelHandle, { passive: true });
    this._element.removeEventListener('DOMMouseScroll', this._mousewheelHandleFirefox, { passive: true });
  }

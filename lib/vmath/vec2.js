...
class vec2
{
   ...
   * Create a zero vector.
   *
   * @deprecated Use {@link vec2.zero} instead.
  ...
  /**
   * Return an object in JSON format that represent this vector.
   *
  ...
  /**
   * Copy value of a specified vector into another vector.
   *
  ...
  /**
   * Perform addition on each component of two vectors respectively.
   *
  ...
  /**
   * Perform subtraction on each component of two vectors respectively.
   *
   * It doesn't matter that any amount of these parameters refer to same vector.
   *
   * @param {vec2} out - Vector to store result.
  ...
  /**
   * Perform multiply on each component of two vectors respectively.
   *
   * It doesn't matter that any amount of these parameters refer to same vector.
   *
   * @param {vec2} out - Vector to store result.
  ...
  /**
   * Perform division on each component of two vectors respectively.
   *
   * It doesn't matter that any amount of these parameters refer to same vector.
   *
   * @param {vec2} out - Vector to store result.
  ...
  /**
   * Perform Math.ceil on each component of a vector.
   *
   * It doesn't matter that any amount of these parameters refer to same vector.
   *
   * @param {vec2} out - Vector to store result.
  ...
  /**
   * Perform Math.floor on each component of a vector.
   *
   * It doesn't matter that any amount of these parameters refer to same vector.
   *
   * @param {vec2} out - Vector to store result.
  ...
  /**
   * Perform Math.min on each component of two vectors respectively.
   *
   * It doesn't matter that any amount of these parameters refer to same vector.
   *
   * @param {vec2} out - Vector to store result.
  ...
  /**
   * Perform Math.round on each component of a vector.
   *
   * It doesn't matter that any amount of these parameters refer to same vector.
   *
   * @param {vec2} out - Vector to store result.
  ...
  /**
   * Calculate the squared euclidian distance between two vectors.
   *
   * @param {vec2} a - The first operand.
   * @param {vec2} b - The second operand.
  ...
  /**
   *Alias of {@link vec2.squaredLength}
   */
  sqrLen()
  {
  ...
  /**
   * Transform a vector with a 2x2 matrix.
   *
   * @param {vec2} out - Vector to store result.
  ...
  /**
   * Transform a vector with a 2x3 matrix.
   *
   * @param {vec2} out - Vector to store result.
   * @param {vec2} a - Vector to transform.
  ...
  /**
   * Transform a vector with a 3x3 matrix.
   *
   * @param {vec2} out - Vector to store result.
   * @param {vec2} a - Vector to transform.
  ...
  /**
   * Transform a vector with a 4x4 matrix.
  ...
  /**
   * Return whether the specified vectors are equal. (Compared using ===)
   *
  ...
  /**
   * Return whether the specified vectors are approximately equal.
   *
   * @param {vec2} a The first vector.
   * @param {vec2} b The second vector.

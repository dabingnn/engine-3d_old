...
class vec3
{
   ...
   * Create a zero vector.
   *
   * @deprecated Use {@link vec3.zero} instead.
  ...
  /**
   * Alias of {@link vec3.squaredLength}.
   */
  sqrLen()
  {
  ...
  /**
   * Transform a vector with a 4x4 matrix. 4th vector component is implicitly '1'.
   *
   * @param {vec3} out - Vector to store result.
  ...
  /**
   * Transform a vector with a quaternion.
   *
   * @param {vec3} out - Vector to store result.
   * @param {vec3} a - Vector to transform.

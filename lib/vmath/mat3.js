...
set(m00, m01, m02, m10, m11, m12, m20, m21, m22)
{
  ...
  {
    return out.set(m00, m01, m02, m10, m11, m12, m20, m21, m22);
  }
...
str()
{
  return `mat3(${this.m00}, ${this.m01}, ${this.m02}, ${this.m03}, ${this.m04}, ${this.m05}, ${this.m06}, ${this.m07}, ${this.m08})`;
}
...
mat3._fromViewUp = (function ()
{
  ...
  {
    if (view.sqrLen() < EPSILON * EPSILON)
    {
      mat3.identity(out);
      return out;
    }

...
class _box {
  constructor(px, py, pz, w, h, l, ox_1, ox_2, ox_3, oy_1, oy_2, oy_3, oz_1, oz_2, oz_3) {
    this.initCenter = vec3.new(px, py, pz);
...
box.fromPoints = (function () {
  ...
  return function (minPos, maxPos) {
    ...
    vec3.scale(halfSize, vec3.subtract(halfSize, maxPos, minPos), 0.5);
 ...
 * @return {box} out
 */
box.setTransform = function (out, mat) {
  mat3.fromMat4(out.orientation, mat);
  mat4.getTranslation(out.center, mat);
  vec3.add(out.center, out.center, out.initCenter);
  return out;
};
...
box.set = function (out, px, py, pz, w, h, l, ox_1, ox_2, ox_3, oy_1, oy_2, oy_3, oz_1, oz_2, oz_3) {
  out.initCenter = vec3.new(px, py, pz);
  out.center = out.initCenter;
  out.size = [w, h, l];

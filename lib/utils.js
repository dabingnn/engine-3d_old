...
import loadSkin from './loaders/skin-loader';
import loadAnim from './loaders/animation-loader';
...
function createJointsTexture(device, skin) {
  const jointCount = skin._skeleton._joints.length;

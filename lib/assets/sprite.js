...
export default class Sprite extends Asset {
  ...
  commit() {
     ...
     */
    if (this._rotated) {
      _s_tmp.set( this._width, this._height, 1.0);
      ...
      _t_tmp.set( this._x, textureHeight - this._y, 0.0);
      mat4.fromTranslation(_mat4_tmp, _t_tmp);
      mat4.multiply(_textureMatrix, _mat4_tmp, _textureMatrix);

      _s_tmp.set( 1 / textureWidth, 1 / textureHeight, 1.0);
      ...
      _t_tmp.set( this._x, textureHeight - (this._y + this._height), 0.0);
      mat4.fromTranslation(_mat4_tmp, _t_tmp);
      mat4.multiply(_textureMatrix, _mat4_tmp, _textureMatrix);

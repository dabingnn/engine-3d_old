...
export default class Node {
   ...
   */
  getLocalMatrix(out) {
    if (this._lmatrix) mat4.set(out,
      this._lmatrix.m00, this._lmatrix.m01, this._lmatrix.m02, this._lmatrix.m03,
      this._lmatrix.m04, this._lmatrix.m05, this._lmatrix.m06, this._lmatrix.m07,
      this._lmatrix.m08, this._lmatrix.m09, this._lmatrix.m10, this._lmatrix.m11,
      this._lmatrix.m12, this._lmatrix.m13, this._lmatrix.m14, this._lmatrix.m15);
    else mat4.fromRTS(out, this.lrot, this.lpos, this.lscale);
    return out;
  }

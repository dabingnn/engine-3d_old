...
export default class PhongMaterial extends Material {
  constructor() {
    ...
    this._effect = new renderer.Effect(
      ...
      [
        ...
        { name: 'USE_DIFFUSETEXTURE', value: false },
        { name: 'USE_EMISSIVE', value: false },
        { name: 'USE_EMISSIVETEXTURE', value: false },
        { name: 'USE_SPECULAR', value: false },
        { name: 'USE_SPECULARTEXTURE', value: false },
  ...
  set useDiffuseTexture(val) {
    this._effect.setOption('USE_DIFFUSETEXTURE', val);
  }
  ...
  set useEmissiveTexture(val) {
    this._effect.setOption('USE_EMISSIVETEXTURE', val);
    if (val === true) {
  ...
  set useSpecularTexture(val) {
    this._effect.setOption('USE_SPECULARTEXTURE', val);
  }

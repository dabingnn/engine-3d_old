...
export default class UnlitMaterial extends Material {
  constructor() {
    ...
    let mainTech = new renderer.Technique(
      ...
      [
        ...
        { name: 'mainTextureTiling', type: renderer.PARAM_FLOAT2 },
        { name: 'mainTextureOffset', type: renderer.PARAM_FLOAT2 }
      ],
    ...
    this.mainTextureTiling = vec2.new(1, 1);
    this.mainTextureOffset = vec2.new(0, 0);
  }
  ...
  set mainTextureTiling(val) {
    this._effect.setValue('mainTextureTiling', val);
  }

  set mainTextureOffset(val) {
    this._effect.setValue('mainTextureOffset', val);
  }
}
...
export default class PbrMaterial extends Material {
  constructor() {
    ...
    let mainTech = new renderer.Technique(
      ['opaque'],
      [
        { name: 'albedo', type: renderer.PARAM_COLOR4 },
    ...
    this._effect = new renderer.Effect(
      ...
      [
        ...
        { name: 'USE_ALBEDO_TEXTURE', value: false },
        { name: 'USE_METALLIC_ROUGHNESS_TEXTURE', value: false },
        { name: 'USE_METALLIC_TEXTURE', value: false },
        { name: 'USE_ROUGHNESS_TEXTURE', value: false },
        { name: 'USE_AO_TEXTURE', value: false },
        { name: 'USE_IBL', value: false },
        { name: 'USE_TEX_LOD', value: false },
    ...
    this.albedo = color4.new(0.8, 0.8, 0.8, 1.0);
    this.metallic = 1.0;
    this.roughness = 0.5;
    this.ao = 0.2;
  ...
  set useAlbedoTexture(val) {
    this._effect.setOption('USE_ALBEDO_TEXTURE', val);
  }
  ...
  set useMetallicTexture(val) {
    this._effect.setOption('USE_METALLIC_TEXTURE', val);
  }
  ...
  set useRoughnessTexture(val) {
    this._effect.setOption('USE_ROUGHNESS_TEXTURE', val);
  }
  ...
  set useAoTexture(val) {
    this._effect.setOption('USE_AO_TEXTURE', val);
  }
  ...
  set useTexLod(val) {
    ...
    this._effect.setOption('USE_TEX_LOD', val);
  }
  ...
  set useShadowMap(val) {
    this._effect.setOption('USE_SHADOW_MAP', val);
  }

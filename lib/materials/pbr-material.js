...
export default class PbrMaterial extends Material {
  constructor() {
    ...
    this._effect = new renderer.Effect(
      ...
      [
        ...
        { name: 'USE_NORMALTEXTURE', value: false },
        { name: 'USE_SKINNING', value: false },
        { name: 'USE_ALBEDOTEXTURE', value: false },
        { name: 'USE_METALROUGHNESSTEXTURE', value: false },
        { name: 'USE_METALLICTEXTURE', value: false },
        { name: 'USE_ROUGHNESSTEXTURE', value: false },
        { name: 'USE_AOTEXTURE', value: false },
        { name: 'USE_IBL', value: false },
        { name: 'USE_TEXLOD', value: false },
        { name: 'USE_OPACITY', value: false },
        { name: 'USE_OPACITYTEXTURE', value: false },
        { name: 'USE_ALPHATEST', value: false },
        { name: 'USE_SHADOWMAP', value: true },
      ]
    );
  ...
  set useAlbedoTexture(val) {
    this._effect.setOption('USE_ALBEDOTEXTURE', val);
  }
  ...
  set useMetallicTexture(val) {
    this._effect.setOption('USE_METALLICTEXTURE', val);
  }
  ...
  set useRoughnessTexture(val) {
    this._effect.setOption('USE_ROUGHNESSTEXTURE', val);
  }
  ...
  set useAoTexture(val) {
    this._effect.setOption('USE_AOTEXTURE', val);
  }
  ...
  set useNormalTexture(val) {
    this._effect.setOption('USE_NORMALTEXTURE', val);
  }
  ...
  set useIBL(val) {
    this._effect.setOption('USE_IBL', val);
  }

  set useTexLod(val) {
    // TODO: check whether EXT_shader_texture_lod is valid.
    this._effect.setOption('USE_TEXLOD', val);
  }
  ...
  set useOpacityTexture(val) {
    this._effect.setOption('USE_OPACITYTEXTURE', val);
    if (val === true) {
      this.useOpacity = val;
    }
  }

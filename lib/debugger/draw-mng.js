...
export default class DrawMng {
  constructor(app) {
    ...
    lineBatchModel.addEffect(lineEffect);
    ...
    app.scene.addModel(lineBatchModel);
    ...
    lineBatchModel2D.addEffect(lineEffect);

    app.scene.addModel(lineBatchModel2D);
  ...
  tick(dt, viewID) {
    ...
    this._lineBatchModel2D._viewID = viewID;

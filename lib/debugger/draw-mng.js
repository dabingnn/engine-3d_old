...
export default class DrawMng {
  constructor(app) {
    ...
    materialWireframe.effect = this._app.assets.get('builtin-wireframe');
    ...
    this._primitives = new LinkedArray(() => {
      return {
        model: (() => {
          ...
          let node = new Node();
          model.setNode(node);
          model.addEffect(materialWireframe.effectInst);
    ...
    materialLine.effect = this._app.assets.get('builtin-line');
    ...
    linesModel.addEffect(materialLine.effectInst);
    ...
    linesModel2D.addEffect(materialLine.effectInst);

...
export default class DrawMng {
  constructor(app) {
    ...
    let materialWireframe = new Material();
    materialWireframe.effectAsset = this._app.assets.get('builtin-wireframe');
    ...
    this._primitives = new LinkedArray(() => {
      return {
        model: (() => {
          ...
          let node = new Node();
          model.setNode(node);
          model.addEffect(materialWireframe.effectAsset.effect);
    ...
    let materialLine = new Material();
    materialLine.effectAsset = this._app.assets.get('builtin-line');
    ...
    linesModel.addEffect(materialLine.effectAsset.effect);
    ...
    linesModel2D.addEffect(materialLine.effectAsset.effect);

  ...
  resl({
    ...
    onDone(data) {
      ...
      if (json.type === 'unlit') {
        ...
        if (props.diffuse) {
          tasks.push(done => {
            app.assets.load(props.diffuse, (err, asset) => {
              ...
              material.setOption('USE_DIFFUSE_TEXTURE', true);
              done();
            });
          });
        }
        ...
        material.setOption('USE_WORLD_POS', props.useWorldPos);
        ...
        if (props.mainTex) {
          tasks.push(done => {
            app.assets.load(props.mainTex, (err, asset) => {
              ...
              material.setOption('USE_MAIN_TEX', true);
              done();
            });
          });
        }
        ...
        if (props.albedoTexture) {
          tasks.push(done => {
            app.assets.load(props.albedoTexture, (err, asset) => {
              ...
              material.setOption('USE_ALBEDO_TEXTURE', true);
              done();
            });
          });
        }
        if (props.metallicTexture) {
          tasks.push(done => {
            app.assets.load(props.metallicTexture, (err, asset) => {
              ...
              material.setOption('USE_METALLIC_TEXTURE', true);
              done();
            });
          });
        }
        if (props.roughnessTexture) {
          tasks.push(done => {
            app.assets.load(props.roughnessTexture, (err, asset) => {
              ...
              material.setOption('USE_ROUGHNESS_TEXTURE', true);
              done();
            });
          });
        }
        if (props.normalTexture) {
          tasks.push(done => {
            app.assets.load(props.normalTexture, (err, asset) => {
              ...
              material.setOption('USE_NORMAL_TEXTURE', true);
              done();
            });
          });
        }
        if (props.aoTexture) {
          tasks.push(done => {
            app.assets.load(props.aoTexture, (err, asset) => {
              ...
              material.setOption('USE_AO_TEXTURE', true);
              done();
            });
          });
        }

  ...
  resl({
    ...
    onDone(data) {
      ...
      if (json.type === 'unlit') {
        ...
        material.effect = app.assets.get('builtin-phong');
        ...
        if (props.diffuseTextureTiling) {
          material.setProperty('diffuseTiling', vec2.new(
              props.diffuseTextureTiling[0],
              props.diffuseTextureTiling[1]
            )
          );
        }

        if (props.diffuseTextureOffset) {
          material.setProperty('diffuseOffset', vec2.new(
              props.diffuseTextureOffset[0],
              props.diffuseTextureOffset[1]
            )
          );
        }
        ...
        if (props.specularTextureTiling) {
          material.setProperty('specularTiling', vec2.new(
              props.specularTextureTiling[0],
              props.specularTextureTiling[1]
            )
          );
        }

        if (props.specularTextureOffset) {
          material.setProperty('specularOffset', vec2.new(
              props.specularTextureOffset[0],
              props.specularTextureOffset[1]
            )
          );
        }
        ...
        if (props.emissiveTextureTiling) {
          material.setProperty('emissiveTiling', vec2.new(
              props.emissiveTextureTiling[0],
              props.emissiveTextureTiling[1]
            )
          );
        }

        if (props.emissiveTextureOffset) {
          material.setProperty('emissiveOffset', vec2.new(
              props.emissiveTextureOffset[0],
              props.emissiveTextureOffset[1]
            )
          );
        }

        if (props.normalTextureTiling) {
          material.setProperty('normalTiling', vec2.new(
              props.normalTextureTiling[0],
              props.normalTextureTiling[1]
            )
          );
        }

        if (props.normalTextureOffset) {
          material.setProperty('normalOffset', vec2.new(
              props.normalTextureOffset[0],
              props.normalTextureOffset[1]
            )
          );
        }
        ...
        material.effect = app.assets.get('builtin-grid');
        ...
        material.effect = app.assets.get('builtin-matcap');
        ...
        if (props.albedoTextureTiling) {
          material.setProperty('albedoTiling', vec2.new(
              props.albedoTextureTiling[0],
              props.albedoTextureTiling[1]
            )
          );
        }

        if (props.albedoTextureOffset) {
          material.setProperty('albedoOffset', vec2.new(
              props.albedoTextureOffset[0],
              props.albedoTextureOffset[1]
            )
          );
        }
        ...
        if (props.metallicTextureTiling) {
          material.setProperty('metallicTiling', vec2.new(
              props.metallicTextureTiling[0],
              props.metallicTextureTiling[1]
            )
          );
        }

        if (props.metallicTextureOffset) {
          material.setProperty('metallicOffset', vec2.new(
              props.metallicTextureOffset[0],
              props.metallicTextureOffset[1]
            )
          );
        }
        ...
        if (props.roughnessTextureTiling) {
          material.setProperty('roughnessTiling', vec2.new(
              props.roughnessTextureTiling[0],
              props.roughnessTextureTiling[1]
            )
          );
        }

        if (props.roughnessTextureOffset) {
          material.setProperty('roughnessOffset', vec2.new(
              props.roughnessTextureOffset[0],
              props.roughnessTextureOffset[1]
            )
          );
        }
        ...
        if (props.aoTextureTiling) {
          material.setProperty('aoTiling', vec2.new(
              props.aoTextureTiling[0],
              props.aoTextureTiling[1]
            )
          );
        }

        if (props.aoTextureOffset) {
          material.setProperty('aoOffset', vec2.new(
              props.aoTextureOffset[0],
              props.aoTextureOffset[1]
            )
          );
        }

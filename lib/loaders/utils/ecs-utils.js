...
function createComponent(app, ent, info, callback) {
  ...
  let comp = app._createComp(ctor, ent);
  ...
  if (info.type === 'Light') {
    ...
    if (info.type === 'Image') {
      ...
      comp.italic = props.italic;
      comp.bold = props.bold;
      comp.fontFamily = props.fontFamily;

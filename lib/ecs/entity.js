...
export default class Entity {
  ...
  addVTweenTask(target, props, option) {
    if (!this._timeline) {
      this._timeline = this._app._vtween.newTimeLine({});
    }

    if (target === 'Entity') {
      let task = this._app._vtween.newTask(this, props, option);
      this._timeline.add(task);
      return;
    }
    ...
    let task = this._app._vtween.newTask(com, props, option);
    this._timeline.add(task);
  }

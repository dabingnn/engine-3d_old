...
export default class LabelRenderData {
  ...
  get positions() {
    return this._modelData.positions;
  }

  get uvs() {
    return this._modelData.uvs;
  }

  updateModelData() {
    if (this._modelDataDirty && this._font) {
      this._modelDataDirty = false;
      let filledChars = this._font.genTextVertices(this._modelData, this._label, this._horizontalAlignPercentage, this._verticalAlignPercentage,

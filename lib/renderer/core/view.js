...
export default class View {
  ...
  updateFrustum() {
    ...
    // left plane
    this._frustum.planes[0].n.set( m.m03 + m.m00, m.m07 + m.m04, m.m11 + m.m08);
    this._frustum.planes[0].d = -(m.m15 + m.m12);
    // right plane
    this._frustum.planes[1].n.set( m.m03 - m.m00, m.m07 - m.m04, m.m11 - m.m08);
    this._frustum.planes[1].d = -(m.m15 - m.m12);
    // bottom plane
    this._frustum.planes[2].n.set( m.m03 + m.m01, m.m07 + m.m05, m.m11 + m.m09);
    this._frustum.planes[2].d = -(m.m15 + m.m13);
    // top plane
    this._frustum.planes[3].n.set( m.m03 - m.m01, m.m07 - m.m05, m.m11 - m.m09);
    this._frustum.planes[3].d = -(m.m15 - m.m13);
    // near plane
    this._frustum.planes[4].n.set( m.m03 + m.m02, m.m07 + m.m06, m.m11 + m.m10);
    this._frustum.planes[4].d = -(m.m15 + m.m14);
    // far plane
    this._frustum.planes[5].n.set( m.m03 - m.m02, m.m07 - m.m06, m.m11 - m.m10);
    ...
    _v3.set(  1,  1,  1); vec3.transformMat4(this._frustum.vertices[0], _v3, this._matInvViewProj);
    _v3.set( -1,  1,  1); vec3.transformMat4(this._frustum.vertices[1], _v3, this._matInvViewProj);
    _v3.set( -1, -1,  1); vec3.transformMat4(this._frustum.vertices[2], _v3, this._matInvViewProj);
    _v3.set(  1, -1,  1); vec3.transformMat4(this._frustum.vertices[3], _v3, this._matInvViewProj);
    _v3.set(  1,  1, -1); vec3.transformMat4(this._frustum.vertices[4], _v3, this._matInvViewProj);
    _v3.set( -1,  1, -1); vec3.transformMat4(this._frustum.vertices[5], _v3, this._matInvViewProj);
    _v3.set( -1, -1, -1); vec3.transformMat4(this._frustum.vertices[6], _v3, this._matInvViewProj);
    _v3.set(  1, -1, -1); vec3.transformMat4(this._frustum.vertices[7], _v3, this._matInvViewProj);
  }
}
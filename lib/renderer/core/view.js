...
export default class View {
  ...
  updateFrustumPlanes() {
    ...
    // left plane
    this._frustumPlanes[0].n.set( m.m03 + m.m00, m.m07 + m.m04, m.m11 + m.m08);
    this._frustumPlanes[0].d = -(m.m15 + m.m12);
    // right plane
    this._frustumPlanes[1].n.set( m.m03 - m.m00, m.m07 - m.m04, m.m11 - m.m08);
    this._frustumPlanes[1].d = -(m.m15 - m.m12);
    // bottom plane
    this._frustumPlanes[2].n.set( m.m03 + m.m01, m.m07 + m.m05, m.m11 + m.m09);
    this._frustumPlanes[2].d = -(m.m15 + m.m13);
    // top plane
    this._frustumPlanes[3].n.set( m.m03 - m.m01, m.m07 - m.m05, m.m11 - m.m09);
    this._frustumPlanes[3].d = -(m.m15 - m.m13);
    // near plane
    this._frustumPlanes[4].n.set( m.m03 + m.m02, m.m07 + m.m06, m.m11 + m.m10);
    this._frustumPlanes[4].d = -(m.m15 + m.m14);
    // far plane
    this._frustumPlanes[5].n.set( m.m03 - m.m02, m.m07 - m.m06, m.m11 - m.m10);

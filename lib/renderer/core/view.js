...
export default class View {
  ...
  updateFrustumPlanes() {
    ...
    // left plane
    vec3.set(this._frustumPlanes[0].n, m.m12 + m.m00, m.m13 + m.m01, m.m14 + m.m02);
    this._frustumPlanes[0].d = -(m.m15 + m.m03);
    // right plane
    vec3.set(this._frustumPlanes[1].n, m.m12 - m.m00, m.m13 - m.m01, m.m14 - m.m02);
    this._frustumPlanes[1].d = -(m.m15 - m.m03);
    // bottom plane
    vec3.set(this._frustumPlanes[2].n, m.m12 + m.m04, m.m13 + m.m05, m.m14 + m.m06);
    this._frustumPlanes[2].d = -(m.m15 + m.m07);
    // top plane
    vec3.set(this._frustumPlanes[3].n, m.m12 - m.m04, m.m13 - m.m05, m.m14 - m.m06);
    this._frustumPlanes[3].d = -(m.m15 - m.m07);
    // near plane
    vec3.set(this._frustumPlanes[4].n, m.m12 + m.m08, m.m13 + m.m09, m.m14 + m.m10);
    this._frustumPlanes[4].d = -(m.m15 + m.m11);
    // far plane
    vec3.set(this._frustumPlanes[5].n, m.m12 - m.m08, m.m13 - m.m09, m.m14 - m.m10);
    this._frustumPlanes[5].d = -(m.m15 - m.m11);

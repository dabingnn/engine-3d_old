...
import { App as AppBase } from 'ecs.js';
...
// other classes
import BoxShape from './framework/particle/shape/box-shape';
import SphereShape from './framework/particle/shape/sphere-shape';
import HemisphereShape from './framework/particle/shape/hemisphere-shape';
import CircleShape from './framework/particle/shape/circle-shape';
import EdgeShape from './framework/particle/shape/edge-shape';
...
registry.registerClass('SphereShape', SphereShape);
registry.registerClass('HemisphereShape', HemisphereShape);

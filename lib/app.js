...
import builtinEffects from '../builtin/effects/index';
...
export default class App extends Engine {
  constructor(canvas, opts = {}) {
    ...
    // create builtin effects and register
    let effects = builtinLoader.loadBuiltinEffects(builtinEffects);
    for (let i = 0; i < effects.length; ++i) {
      this._assetMng.add(effects[i]._uuid, effects[i]);
    }

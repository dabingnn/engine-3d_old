...
import { vec3, random, randomRange, color4, vec2, quat, toRadian, mat4 } from 'vmath';
...
let _name2VertAttrs = {
  ...
  'UV0': { name: gfx.ATTR_UV0, type: gfx.ATTR_TYPE_FLOAT32, num: 2, flag: 'uv0' }, // size, rotateAngle

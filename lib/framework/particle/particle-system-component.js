...
let _name2VertAttrs = {
  ...
  'Normal': { name: gfx.ATTR_NORMAL, type: gfx.ATTR_TYPE_FLOAT32, num: 3, flag: 'normal' },
  'Tangent': { name: gfx.ATTR_TANGENT, type: gfx.ATTR_TYPE_FLOAT32, num: 3, flag: 'tangent' },
...
// corner data for computing vertex pos in vertex shader, can be computed by (uv - 0.5), so no need now.
// let _corners = [
//   -0.5, -0.5, // bottom-left

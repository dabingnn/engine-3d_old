  ...
  evaluate(time) {
    switch (this._mode) {
      case 'color':
        return this._color;
      case 'twoColors':
        return this._color.set( randomRange(this._colorMin.r, this._colorMax.r), randomRange(this._colorMin.g, this._colorMax.g), randomRange(this._colorMin.b, this._colorMax.b), randomRange(this._colorMin.a, this._colorMax.a));
      case 'randomColor':

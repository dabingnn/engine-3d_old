...
export default class LimitVelocityOvertimeModule {
  ...
  animate(p) {
    ...
    if (this._separateAxes) {
      ...
      vec3.scale(dampedVel, dampedVel, dampenBeyondLimit(vec3.length(p.ultimateVelocity), this._limit.evaluate(normalizedTime, p.randomSeed), this._dampen));
    }

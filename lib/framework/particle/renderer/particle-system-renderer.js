...
let _name2VertAttrs = {
  ...
  'uv': { name: gfx.ATTR_UV, type: gfx.ATTR_TYPE_FLOAT32, num: 4 },
    ...
    for (let i = 0; i < this.particleSystem._particles.length; ++i) {
      ...
      for (let j = 0; j < 4; ++j) { // four verts per particle.
        ...
        if (this._vertAttrFlags.color0) {
          ...
          attrs.push(vec4.set(_vertAttrsCache.color0, p.ultimateVelocity.x, p.ultimateVelocity.y, p.ultimateVelocity.z, scale));
        }

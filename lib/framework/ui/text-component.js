...
function _genBitmapFontVerts(
  ...
  let cursorY = 0;
  let defaultCharInfo = font._characters[32];
  ...
  function _fillLine(para, start, end) {
    ...
    for (let i = 0; i < end - start; ++i) {
      ...
      let charInfo = font._characters[charCode] || defaultCharInfo;
      ...
      vec2.copy(out.uvs[4 * idx + 0], charInfo.uvs[0]);
      vec2.copy(out.uvs[4 * idx + 1], charInfo.uvs[1]);
      vec2.copy(out.uvs[4 * idx + 2], charInfo.uvs[2]);
      vec2.copy(out.uvs[4 * idx + 3], charInfo.uvs[3]);

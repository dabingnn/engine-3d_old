...
export default class ScreenSystem extends System {
  ...
  _tickScreen(screen) {
    ...
    // process layout
    this._processLayout(screenRoot, this._entities);

    // render screen elements
    this._renderScreen(screenRoot);
  }
  ...
  _processLayout(screenRoot, entities) {

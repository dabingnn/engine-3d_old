...
export default class MaskComponent extends WidgetComponent {
  ...
  calcVertexData(x, y, w, h) {
    if (this._vertexDataDirty) {
      ...
      this._cachedVertexData.lposList[0].set( x, y, 0);
      this._cachedVertexData.lposList[1].set( x + w, y, 0);
      this._cachedVertexData.lposList[2].set( x, y + h, 0);
      this._cachedVertexData.lposList[3].set( x + w, y + h, 0);
    }
